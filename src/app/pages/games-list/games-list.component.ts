...
export class GamesListComponent implements OnInit {
    ...
    initializeGames() {
        const GAME_LIST: { [key: number]: { title: string; videoUrl?: string } } = {
            ...
            3: { title: 'نشاط الشطب', videoUrl: 'https://youtu.be/4cqoPBjVyGA' },
            4: { title: 'اختر الشكل المنتمي للمجموعة', videoUrl: 'https://youtu.be/EUSipchTXK8' },
            5: { title: 'نشاط التطابق البصري', videoUrl: 'https://youtu.be/uk4S7XNZM7M' },
            6: { title: 'نشاط اوجد الاختلافات بين الصورتين', videoUrl: 'https://youtu.be/S62YQi6PACE' },
            7: { title: 'لعبه المتاهات لزياده مده الانتباه', videoUrl: 'https://youtu.be/2USxHHuZ1Qw' },
            8: { title: 'لفت واتساق الانتباه', videoUrl: 'https://youtu.be/xu4asXADnx4' },
            9: { title: 'استخرج الكلمه والرمز من متعدد', videoUrl: 'https://youtu.be/3H2VqWPy2EQ' },
            10: { title: 'لعبه التمييز السمعي للاصوات', videoUrl: 'https://youtu.be/Oau4cWbvk6M' },
            11: { title: 'المرونه في نقل الانتباه الالوان', videoUrl: 'https://youtu.be/w_PJgIEZLcQ' },
            12: { title: 'المرونه في الانتباه السمعي للحروف', videoUrl: 'https://youtu.be/Po2SjhPRLko' },
            13: { title: 'زياده مده الانتباه البصري', videoUrl: 'https://youtu.be/Ui4IMGiQG_c' },
